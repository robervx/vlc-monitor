...
Es el mismo problema de "conciliación segmento-a-segmento" descrito en `docs/investigacion/un documento de diseño archivado` §6 — no un *snap* punto→línea, sino emparejar dos segmentaciones independientes de la misma calle.

## 1. Problema / motivación

Quien usa el cordón o el simulador quiere que la herramienta tenga en cuenta **lo que pasa de verdad ahora mismo** en la calzada (un corte ya activo, una congestión), no solo la topología teórica de OSM. Y quiere ver el estado real sobre el mismo mapa donde planifica los cortes.
