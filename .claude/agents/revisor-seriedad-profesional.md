...
description: >
  ...
  cualquier UI/copy visible para el usuario final (mandos de gestión municipal), para auditar que
  ...
  documentación transmitan la seriedad que espera un organización (nombre de marca correcto,
...
- La identidad de marca vigente: "Intelligent City Monitor", pivote documentado en
  ...
  antiguos, a un proyecto anterior o a módulos 1A/1B/2/3 son legado — señálalas si aparecen
