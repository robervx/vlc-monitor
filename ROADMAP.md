...
| **F3** | Índice de Pulso de Distrito | Índice compuesto (tráfico + aire + meteo adversa + incidencias), inspirado en el CII de World Monitor | `010` (depende de `001`, `002`, `004`, `026`) |
