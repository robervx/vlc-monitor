...
| `012` | Geolocalización de usuario + "qué tengo más cerca" | F5 | Planned — no redactada aún. Requiere decisión explícita sobre framing "herramienta policial de campo" antes de pasar a Draft (ver `docs/investigacion/un backlog archivado`) | `000` |
| `013` | Motor de insights y alertas operativas | F3.6 | Planned — no redactada aún. Debe diseñarse cumpliendo "avisa, no actúa" (`CLAUDE.md` §4) — ver tensión documentada en `docs/investigacion/un backlog archivado` | `001`, `002`, `004`, `008`, `009` |
