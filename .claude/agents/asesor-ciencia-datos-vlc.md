...
description: >
  ...
  que sea útil en la toma de decisiones operativas de un responsable de gestión municipal en Valencia. Da
...
1. **Entiende la decisión que hay al otro lado del dato.** Antes de hablar de agregaciones,
   pregunta (o infiere del contexto) qué decisión operativa va a tomar el mando de gestión municipal
