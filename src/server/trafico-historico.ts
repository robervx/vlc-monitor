...
import { construirHistoricoDistrito } from '../services/trafico-historico';
import type { HistoricoTrafico, RollupDiario, SnapshotHorario } from '../services/trafico-historico';
import snapshots from '../../data/trafico-historico.json' with { type: 'json' };
import rollups from '../../data/trafico-historico-diario.json' with { type: 'json' };
