...
Quien planifica cortes (evento, obra, incendio) quiere ver, antes de aplicarlos, **el efecto en cadena real** de cada corte siguiendo el sentido de circulación:
