...
Quien abre la herramienta en el móvil, en la calle, necesita: ver el mapa sin que un panel se lo coma, alcanzar todos los controles con el pulgar de una mano, y que el contenido no quede bajo el notch ni bajo la barra de gestos. Hoy nada de eso está resuelto para pantallas pequeñas.
