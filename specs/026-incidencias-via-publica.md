...
- **Riesgo (mitigado con aviso en UI):** vigencia de permiso ≠ corte real activo — un responsable podría interpretar la fecha de fin como "hasta cuándo está cortada la calle" cuando en realidad es solo hasta cuándo es válido el permiso. Mitigado con el DoD de aviso explícito.
