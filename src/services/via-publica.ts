...
export async function fetchIncidenciasViaPublica(
  ...
  // sin este chequeo, `body.features.map` petaba con un TypeError confuso y
  ...
  if (!Array.isArray(body.features)) {
    throw new Error('Geoportal (vía pública) respondió sin "features" — posible incidencia del servicio');
  }
