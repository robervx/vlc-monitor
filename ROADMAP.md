...
| **F3.6** | Motor de insights y alertas operativas | Panel de insights bajo el mapa + alertas emergentes (popup → rail lateral, spec `013` v4) + dashboard de indicadores (KPIs) + sistema de notificaciones sobre alertas de interés (eventos, cortes). Debe cumplir "avisa, no actúa" (`CLAUDE.md` §4) — ver `docs/investigacion/BACKLOG_FUNCIONALIDADES_2026-08-18.md` | `013`, `014`, `034` |
