...
**Este NO es** el antiguo proyecto un proyecto anterior distinto. Ese pivote quedó documentado y superado en `docs/01_VIABILIDAD_VISION_Y_PROCESO.md` §3.6. Si encuentras referencias sueltas a "situación operativa", "proyecto anterior" o "tiempo-real policial" en algún fichero antiguo, son legado — no las extiendas ni las tomes como guía de producto.
