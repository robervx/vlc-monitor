...
Quien abre la herramienta en calle no quiere buscar en un mapa completo de Valencia — quiere saber, desde donde está parado, cuál es el aparcamiento libre más próximo, la estación Valenbisi más próxima y el tramo con incidencia de tráfico más próximo, en una lista corta y ordenada por distancia.
...
|---|---|---|
| 1 | 2026-08-19 | Creación, `Draft`. Desbloqueada por ADR-002. Pendiente de implementación y verificación en navegador antes de pasar a `Implemented`. |
