...
- Flechas de sentido de circulación (`src/services/flechas-sentido.ts`, capa `flechas-sentido` de `main.ts`) visibles mientras el modo está activo, a partir de zoom 15 — antes solo con `?debug=grafo`.
